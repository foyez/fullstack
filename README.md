...
| CIDR | Subnet Mask     | Host Bits | Usable Hosts | Subnet Size | **Example Subnet Range**        |
| ---- | --------------- | --------- | ------------ | ----------- | ------------------------------- |
| /8   | 255.0.0.0       | 24        | 16,777,214   | 16,777,216  | 192.0.0.0 – 192.255.255.255     |
| /9   | 255.128.0.0     | 23        | 8,388,606    | 8,388,608   | 192.128.0.0 – 192.255.255.255   |
| /10  | 255.192.0.0     | 22        | 4,194,302    | 4,194,304   | 192.192.0.0 – 192.255.255.255   |
| /11  | 255.224.0.0     | 21        | 2,097,150    | 2,097,152   | 192.224.0.0 – 192.255.255.255   |
| /12  | 255.240.0.0     | 20        | 1,048,574    | 1,048,576   | 192.240.0.0 – 192.255.255.255   |
| /13  | 255.248.0.0     | 19        | 524,286      | 524,288     | 192.248.0.0 – 192.255.255.255   |
| /14  | 255.252.0.0     | 18        | 262,142      | 262,144     | 192.252.0.0 – 192.255.255.255   |
| /15  | 255.254.0.0     | 17        | 131,070      | 131,072     | 192.254.0.0 – 192.255.255.255   |
| /16  | 255.255.0.0     | 16        | 65,534       | 65,536      | 192.168.0.0 – 192.168.255.255   |
| /17  | 255.255.128.0   | 15        | 32,766       | 32,768      | 192.168.0.0 – 192.168.127.255   |
| /18  | 255.255.192.0   | 14        | 16,382       | 16,384      | 192.168.0.0 – 192.168.63.255    |
| /19  | 255.255.224.0   | 13        | 8,190        | 8,192       | 192.168.0.0 – 192.168.31.255    |
| /20  | 255.255.240.0   | 12        | 4,094        | 4,096       | 192.168.0.0 – 192.168.15.255    |
| /21  | 255.255.248.0   | 11        | 2,046        | 2,048       | 192.168.0.0 – 192.168.7.255     |
| /22  | 255.255.252.0   | 10        | 1,022        | 1,024       | 192.168.0.0 – 192.168.3.255     |
| /23  | 255.255.254.0   | 9         | 510          | 512         | 192.168.0.0 – 192.168.1.255     |
| /24  | 255.255.255.0   | 8         | 254          | 256         | **192.168.1.0 – 192.168.1.255** |
| /25  | 255.255.255.128 | 7         | 126          | 128         | 192.168.1.0 – 192.168.1.127     |
| /26  | 255.255.255.192 | 6         | 62           | 64          | 192.168.1.0 – 192.168.1.63      |
| /27  | 255.255.255.224 | 5         | 30           | 32          | 192.168.1.0 – 192.168.1.31      |
| /28  | 255.255.255.240 | 4         | 14           | 16          | 192.168.1.0 – 192.168.1.15      |
| /29  | 255.255.255.248 | 3         | 6            | 8           | 192.168.1.0 – 192.168.1.7       |
| /30  | 255.255.255.252 | 2         | 2            | 4           | 192.168.1.0 – 192.168.1.3       |
| /31  | 255.255.255.254 | 1         | 0            | 2           | 192.168.1.0 – 192.168.1.1       |
| /32  | 255.255.255.255 | 0         | 1            | 1           | 192.168.1.0 (single IP)         |

* **Subnet size (Increment)** represents how many IP addresses are in each subnet.
